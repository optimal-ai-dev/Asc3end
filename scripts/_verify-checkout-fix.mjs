// Temporary diagnostic script — deleted after use. Verifies the fetch-httpClient fix resolved
// the "connection to Stripe" error, using a throwaway confirmed test user.
...
const email = `verify-fix-${Date.now()}@example.com`;
const password = "Verify-Fix-Test-123!";
